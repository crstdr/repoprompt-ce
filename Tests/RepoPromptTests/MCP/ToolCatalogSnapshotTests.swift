...
final class ToolCatalogSnapshotTests: XCTestCase {
    ...
    func testAgentSessionLinkNoLongerAdvertisesRetiredOperations() async throws {
        ...
        XCTAssertEqual(properties["observer_session_id"]?.objectValue?["type"]?.stringValue, "string")
        ...
        for contract in [
            ...
            "session overseeing you, also called your overseer",
    ...
    private static let expectedSignatures: [String] = [
        ...
        "20|agent_session_link|enabled=true|ann=title=nil,readOnly=false,destructive=false,idempotent=nil,openWorld=false|desc=a0ba804377a514013cf60c0a0bf0c451bf08c62f2fd44c8f6cef63e5359d66dc|schema=a769f69af6c849efc10abbf1fa8e0686d05a061e9bfd267961d4e9d9c94761d3",
